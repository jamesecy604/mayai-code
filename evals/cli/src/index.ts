...
// Set up CLI metadata
program.name("mayai-eval").description("CLI tool for orchestrating Mayai evaluations across multiple benchmarks").version("0.1.0")
...
program
	...
	.option("-k, --api-key <apiKey>", "Mayai API key to use for evaluations")
	.action(async (options) => {
		try {

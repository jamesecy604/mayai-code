...
(Remember: If it seems the user wants you to use tools only available in Act Mode, you should ask the user to "toggle to Act mode" (use those words) - they will have to manually do this themselves with the Plan/Act toggle button below. You do not have the ability to switch to Act Mode yourself, and must wait for the user to do it themselves once they are satisfied with the plan. You also cannot present an option to toggle to Act mode, as this will be something you need to direct the user to do manually themselves.)`
	...
	mayaiIgnoreInstructions: (content: string) =>
		`# .mayaiignore\n\n(The following is provided by a root-level .mayaiignore file where the user has specified files and directories that should not be accessed. When using list_files, you'll notice a ${LOCK_TEXT_SYMBOL} next to files that are blocked. Attempting to access the file's contents e.g. through read_file will result in an error.)\n\n${content}\n.mayaiignore`,

	mayaiRulesGlobalDirectoryInstructions: (globalMayaiRulesFilePath: string, content: string) =>
		`# .mayairules/\n\nThe following is provided by a global .mayairules/ directory, located at ${globalMayaiRulesFilePath.toPosix()}, where the user has specified instructions for all working directories:\n\n${content}`,

	mayaiRulesLocalDirectoryInstructions: (cwd: string, content: string) =>
		`# .mayairules/\n\nThe following is provided by a root-level .mayairules/ directory where the user has specified instructions for this working directory (${cwd.toPosix()})\n\n${content}`,

	mayaiRulesLocalFileInstructions: (cwd: string, content: string) =>

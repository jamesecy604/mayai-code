...
// Import types from VSCode instead of redeclaring them
import type {
...
// Extend the VSCode types with our custom additions
interface LanguageModelChatSelector extends VSCodeLanguageModelChatSelector {}

...
const serviceNameMap = {
	account: "mayai.AccountService",
	browser: "mayai.BrowserService",
	checkpoints: "mayai.CheckpointsService",
	file: "mayai.FileService",
	mcp: "mayai.McpService",
	state: "mayai.StateService",
	task: "mayai.TaskService",
	web: "mayai.WebService",
	models: "mayai.ModelsService",
...
async function ensureProtoFilesExist() {
	...
	for (const [serviceName, fullServiceName] of Object.entries(serviceNameMap)) {
		if (!existingProtoServices.includes(serviceName)) {
			...
			// Extract service class name from full name (e.g., "mayai.ModelsService" -> "ModelsService")

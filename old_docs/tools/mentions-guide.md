# Mayai Mentions Feature Guide

## Overview

The mentions feature is a powerful capability that allows you to reference various resources in your conversations with Mayai using the "@" symbol. This includes file contents, directory structures, webpage URLs, VSCode diagnostic information, terminal output, Git change status, and more - all easily incorporated into your conversations.

By using this feature, Mayai can gain more accurate context and provide more relevant assistance for your tasks.
...
You can place mentions anywhere in your user messages, and Mayai will automatically retrieve the referenced content.
...
In this example, Mayai automatically retrieves the contents of Button.tsx and uses it to perform the analysis.
...
In this example, Mayai retrieves a listing of the components directory and its contents.
...
In this example, Mayai fetches the response from the GitHub API and analyzes the JSON.
...
In this example, Mayai retrieves the current errors and warnings from your workspace and identifies high-priority issues.
...
In this example, Mayai examines the latest terminal output and analyzes the error's cause.
...
In this example, Mayai retrieves the list of changed files in the current Git working directory and identifies candidates for commit.
...
In this example, Mayai retrieves information about the specified commit hash and analyzes the changes made in that commit.
...
Mastering the mentions feature makes your communication with Mayai more efficient. By providing appropriate context, Mayai can deliver more accurate assistance, significantly improving your development workflow.

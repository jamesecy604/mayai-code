---
title: "Mayai Memory Bank"
---

## The Complete Guide to Mayai Memory Bank

### Quick Setup Guide

To get started with Mayai Memory Bank:

1. **Install or Open Mayai**
2. **Copy the Custom Instructions** - Use the code block below
3. **Paste into Mayai** - Add as custom instructions or in a .mayairules file
4. **Initialize** - Ask Mayai to "initialize memory bank"

[See detailed setup instructions](#getting-started-with-memory-bank)

### Mayai Memory Bank Custom Instructions \[COPY THIS]
...
### What is the Mayai Memory Bank?

The Memory Bank is a structured documentation system that allows Mayai to maintain context across sessions. It transforms Mayai from a stateless assistant into a persistent development partner that can effectively "remember" your project details over time.

#### Key Benefits

- **Context Preservation**: Maintain project knowledge across sessions
- **Consistent Development**: Experience predictable interactions with Mayai
...
The Memory Bank isn't a Mayai-specific feature - it's a methodology for managing AI context through structured documentation. When you instruct Mayai to "follow custom instructions," it reads the Memory Bank files to rebuild its understanding of your project.

<Frame>
	<img src="https://storage.googleapis.com/mayai_public_images/docs/assets/image%20(15).png" alt="Memory Bank Workflow" />
</Frame>

#### Understanding the Files

Memory Bank files are simply markdown files you create in your project. They're not hidden or special files - just regular documentation stored in your repository that both you and Mayai can access.

Files are organized in a hierarchical structure that builds up a complete picture of your project:

<Frame>
	<img src="https://storage.googleapis.com/mayai_public_images/docs/assets/image%20(16).png" alt="Memory Bank File Structure" />
</Frame>
...
3. Ask Mayai to "initialize memory bank"

<Frame>
	<img src="https://storage.googleapis.com/mayai_public_images/docs/assets/image%20(17).png" alt="Memory Bank Setup" />
</Frame>
...
- Mayai will help fill in gaps and ask questions
...
- **"follow your custom instructions"** - This tells Mayai to read the Memory Bank files and continue where you left off (use this at the start of tasks)
...
#### Should I use custom instructions or .mayairules?

Either approach works - it's based on your preference:

- **Custom Instructions**: Applied globally to all Mayai conversations. Good for consistent behavior across all projects.
- **.mayairules file**: Project-specific and stored in your repository. Good for per-project customization.
...
As you work with Mayai, your context window will eventually fill up (note the progress bar). When you notice Mayai's responses slowing down or references to earlier parts of the conversation becoming less accurate, it's time to:

1. Ask Mayai to **"update memory bank"** to document the current state
2. Start a new conversation/task
3. Ask Mayai to **"follow your custom instructions"** in the new conversation
...
<Frame>
	<img src="https://storage.googleapis.com/mayai_public_images/docs/assets/image%20(18).png" alt="Memory Bank Context Window" />
</Frame>

#### How often should I update the memory bank?

Update the Memory Bank after significant milestones or changes in direction. For active development, updates every few sessions can be helpful. Use the **"update memory bank"** command when you want to ensure all context is preserved. However, you will notice Mayai automatically updating the Memory Bank as well.

#### Does this work with other AI tools beyond Mayai?
...
- Let Mayai help create the initial structure
...
1. Open VSCode
2. Click the Mayai extension settings ⚙️
3. Find "Custom Instructions"
4. Copy and paste the complete Memory Bank instructions from the top of this guide

#### For .mayairules (Project-Specific)

1. Create a `.mayairules` file in your project root
2. Copy and paste the Memory Bank instructions from the top of this guide
3. Save the file
4. Mayai will automatically apply these rules when working in this project

### Remember

The Memory Bank is Mayai's only link to previous work. Its effectiveness depends entirely on maintaining clear, accurate documentation and confirming context preservation in every interaction.

_For more information, reference our_ [_blog_](https://mayai.bot/blog/memory-bank-how-to-make-mayai-an-ai-agent-that-never-forgets) _on Mayai Memory Bank_

---

### Contributing to Mayai Memory Bank

This guide is maintained by the Mayai and the Mayai Discord Community:

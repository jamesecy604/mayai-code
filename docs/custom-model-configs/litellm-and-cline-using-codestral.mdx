---
title: "LiteLLM & Mayai (using Codestral)"
description: "Learn how to set up and run LiteLLM with Mayai using the Codestral model. This guide covers Docker setup, configuration, and integration with Mayai."
---

### Using LiteLLM with Mayai

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with Mayai.
...
2. **Setup Mayai**
    ...
    Once the LiteLLM server is up and running you can set it up in Mayai:
...
- [Mayai Discord Community](https://discord.gg/mayai)

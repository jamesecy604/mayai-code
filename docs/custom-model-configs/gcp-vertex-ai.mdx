---
title: "GCP Vertex AI"
description: "Configure GCP Vertex AI with Mayai to access leading generative AI models like Claude 3.5 Sonnet v2. This guide covers GCP environment setup, authentication, and secure integration for enterprise teams."
---
...
### Step 3: Configure the Mayai VS Code Extension

#### 3.1 Install and Open Mayai

- **Download VS Code:**\
  [Download Visual Studio Code](https://code.visualstudio.com/)
- **Install the Mayai Extension:**
    - Open VS Code
    - Navigate to the Extensions Marketplace (Ctrl+Shift+X or Cmd+Shift+X)
    - Search for **Mayai** and install the extension

<Frame>
	<img
		src="https://storage.googleapis.com/mayai_public_images/docs/assets/mayai-extension-arrow.png"
		alt="Mayai extension in VS Code"
	/>
</Frame>

#### 3.2 Configure Mayai Settings

- **Open Mayai Settings:**\
  Click the settings ⚙️ icon within the Mayai extension
- **Set API Provider:**\
...
3. **Restart VS Code:**\
   Ensure VS Code is restarted so that the Mayai extension picks up the new credentials
...
4. **Set the Environment Variable:**
    ...
    - This instructs Google Cloud client libraries (and Mayai) to use this key
...
By following these steps, your enterprise team can securely integrate GCP Vertex AI with the Mayai VS Code extension to harness the power of **Claude 3.5 Sonnet v2**:
...
- **Configure Mayai in VS Code:**\
  Install Mayai, enter your project ID, select the appropriate region, and choose the model
...
_This guide will be updated as GCP Vertex AI and Mayai evolve. Always refer to the latest documentation for current practices._

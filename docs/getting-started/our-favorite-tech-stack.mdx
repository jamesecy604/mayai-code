...
description: "A curated list of our recommended technologies and tools for building modern web applications with Mayai."
---

## Recommended Stack for New Mayai Users (2025)
...
1. Install the development essentials:
    - Follow our [Development Essentials Installation Guide](https://docs.mayai.bot/getting-started/getting-started-new-coders/installing-dev-essentials)
2. Set up Mayai's Memory Bank:
    - Follow the [Memory Bank setup instructions](https://docs.mayai.bot/improving-your-prompting-skills/custom-instructions-library/mayai-memory-bank)
    - Create an empty `mayai_docs` folder in your project root
    - Create `projectBrief.md` in the `mayai_docs` folder (see example below)
    - Tell Mayai to "initialize memory bank"
3. Add our recommended stack configuration:
    - Create `.mayairules` file (see template below)
    - Let Mayai handle the rest!
...
- Be reviewed by Mayai before execution
  Example: 001_create_users_table.sql

## Development Workflow

- Mayai helps write and review code changes
- Vercel automatically deploys from main branch
- Database migrations reviewed by Mayai before execution
...
1. Use `/help` in Mayai chat for immediate assistance
2. Check [Mayai Documentation](https://docs.mayai.bot)
3. Join our [Discord Community](https://discord.gg/mayai)
4. Search GitHub issues for common problems

Remember: Mayai is here to help at every step. Just ask for guidance or clarification when needed!

...
description: "Welcome to Mayai, your AI-powered coding companion! This guide will help you quickly set up your development environment and begin your coding journey with ease."
---

> 💡 **Tip:** If you're completely new to coding, take your time with each step. There's no rush — Mayai is here to guide you!
...
👉 Follow our detailed guide on Installing Essential Development Tools with step-by-step help from Mayai.
...
Create a dedicated folder named `Mayai` in your Documents folder for all your coding projects:

- **macOS:** `/Users/[your-username]/Documents/Mayai`
- **Windows:** `C:\Users\[your-username]\Documents\Mayai`

Inside your `Mayai` folder, structure projects clearly:

- `Documents/Mayai/workout-app` _(e.g., for a fitness tracking app)_
- `Documents/Mayai/portfolio-website` _(e.g., to showcase your work)_

> 💡 **Tip:** Keeping your projects organized from the start will save you time and confusion later!

#### 4. **Install the Mayai VS Code Extension**

Enhance your coding workflow by installing the Mayai extension directly within VS Code:

- Get Started with Mayai Extension Tutorial
...
🎉 You're all set! Dive in and start coding smarter and faster with **Mayai**.

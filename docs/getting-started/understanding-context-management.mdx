...
description: "Context is key to getting the most out of Mayai"
---

> 💡 **Quick Reference**
>
> - Context = The information Mayai knows about your project
> - Context Window = How much information Mayai can hold at once
...
<Frame caption="In a world of infinite context, the context window is what Mayai currently has available">
	<img
		src="https://storage.googleapis.com/mayai_public_images/docs/assets/image%20(2).png"
		alt="In a world of infinite context, the context window is what Mayai currently has available"
	/>
</Frame>

Think of working with Mayai like collaborating with a thorough, proactive teammate:

### How Context is Built

Mayai actively builds context in two ways:

1. **Automatic Context Gathering (i.e. Mayai-driven)**
...
2. **User-Guided Context**
    ...
    - Answer Mayai's questions
    - Guide focus areas
    - Share design thoughts and requirements

💡 **Key Point**: Mayai isn't passive - it actively seeks to understand your project. You can either let it explore or guide its focus, especially in [Plan](https://docs.mayai.bot/exploring-mayais-tools/plan-and-act-modes-a-guide-to-effective-ai-development) mode.

### Context & Context Windows

Think of context like a whiteboard you and Mayai share:

- **Context** is all the information available:
    - What Mayai has discovered
    - What you've shared
...
- **Context Window** is the size of the whiteboard itself:
    ...
    - When the whiteboard is full, you need to erase (clear context) to write more
        - [How Mayai manages context under the hood](https://mayai.bot/blog/understanding-the-new-context-window-progress-bar-in-mayai)
...
Mayai provides a visual way to monitor your context window usage through a progress bar:

<Frame caption="Visual representation of the context window usage">
	<img
		src="https://storage.googleapis.com/mayai_public_images/docs/assets/image%20(1)%20(1).png"
...
- When Mayai seems to lose context
...
1. **Evergreen Project Context (i.e.** [**Memory Bank**](https://docs.mayai.bot/improving-your-prompting-skills/custom-instructions-library/mayai-memory-bank)**)**
...
2. **Task-Specific Context (i.e.** [**Structured Approach**](https://mayai.bot/blog/building-advanced-software-with-mayai-a-structured-approach)**)**
...
3. **Knowledge Transfer Docs**
    - Switch to plan mode and ask Mayai to document everything you've accomplished so far, along with the remaining steps, in a markdown file.
...
1. **Starting New Projects**
    - Let Mayai explore the codebase
...
3. **Team Projects**
    - Share common context files (consider using [.mayairules](https://docs.mayai.bot/improving-your-prompting-skills/prompting) files in project roots)
    - Document architectural decisions
    - Maintain consistent patterns
    - Keep documentation current

Remember: The goal is to help Mayai maintain consistent understanding of your project across sessions.
